...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_sweetalert__ = __webpack_require__(31);
...
var app = new Vue({
  ...
  methods: {
    addshopkeepermodal: function addshopkeepermodal() {
      $('#addshopkeeper').modal('show');
    },
    getallshopkeeper: function getallshopkeeper() {
      var _this = this;
      var getAllshopkeeperurl = $('#urlshopkeeperget').val();
      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(getAllshopkeeperurl).then(function (response) {
        _this.allshopkeeper = response.data;
      }).catch(function (error) {});
    },
    addShopkeeper: function addShopkeeper() {
      //alert("hell world");
      var shopkeeperAddUrl = $('#urlshopkeeperadd').val();
      console.log(shopkeeperAddUrl);
      var _this = this;
      console.log(_this.shopkeeperVal);
      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post(shopkeeperAddUrl, _this.shopkeeperVal).then(function (response) {
        if (response.status == 200 && response.data == 'shopkeeperadded') {
          _this.shopkeeperVal = {};
          $('#addshopkeeper').modal('hide');
          _this.getallshopkeeper();

          __WEBPACK_IMPORTED_MODULE_0_sweetalert___default()("Shopkeeper added Successfully!", "", "success");
        }
      }).catch(function (error) {
    ...
    editshopkeeperModal: function editshopkeeperModal() {
      var oTable = $('#society-table').dataTable();

      var row;
      var _this = this;
      if (event.target.tagName == "BUTTON") row = event.target.parentNode.parentNode;else if (event.target.tagName == "I") row = event.target.parentNode.parentNode.parentNode;
    ...
    shopkeeperEditSubmit: function shopkeeperEditSubmit() {
      var _this = this;
      var editshopkeeper = {};
      var userId = $('#euserid').val();
      var shopkeeperAddUrl = $('#urlshopkeeperedit').val();

      editshopkeeper.storeadmin = $('#estorename').val();
      editshopkeeper.mobile = $('#emobile').val();

      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post(shopkeeperAddUrl + '/' + userId, editshopkeeper).then(function (response) {
        if (response.status == 200 && response.data == 'shopkeeperupdated') {
          _this.getallshopkeeper();
          $('#shopkeepereditmodal').modal('hide');
          __WEBPACK_IMPORTED_MODULE_0_sweetalert___default()("Shopkeeper Updated Successfully!", "", "success");
        }
      }).catch(function (error) {});
    },
    deleteShopkeeper: function deleteShopkeeper(id) {
      var _this = this;
      var deleteShopkeeperUrl = $('#urlshopkeeperdel').val();
      __WEBPACK_IMPORTED_MODULE_0_sweetalert___default()({
        ...
        if (willDelete) {
          __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(deleteShopkeeperUrl + '/' + id).then(function (resp) {
            var respnc = resp.data;
            if (respnc == 'shopkeeperdeleted') {
              //swal("Coupon deleted Successfully!", "", "success");
              _this.getallshopkeeper();
              __WEBPACK_IMPORTED_MODULE_0_sweetalert___default()("Shopkeeper has been deleted!", {
                icon: "success"
              });
            }
          }).catch(function (resp) {
