...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1), __webpack_require__(29).setImmediate))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_sweetalert__ = __webpack_require__(54);
...
var app = new Vue({
  ...
  methods: {
    addCouponmodal: function addCouponmodal() {
      $('#addcouponmodal').modal('show');
    },
    addCoupon: function addCoupon() {
      //alert("hell world");
      var couponAddUrl = $('#urlcouponadd').val();
      console.log(couponAddUrl);
      var _this = this;
      var coupontail = {};
      var couponImage = $('#coupon-image').prop('files')[0] == undefined ? '' : $('#coupon-image').prop('files')[0];
      ...
      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post(couponAddUrl, form_data).then(function (response) {
        ...
        if (response.status == 200 && response.data == 'coupon_created') {
          ...
          _this.getallCoupon();
          __WEBPACK_IMPORTED_MODULE_0_sweetalert___default()("Coupon Added Successfully!", "", "success");
        }
    ...
    getallCoupon: function getallCoupon() {
      var _this = this;
      var getAllCouponurl = $('#urlcouponget').val();
